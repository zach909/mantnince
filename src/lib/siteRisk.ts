/**
 * Local, offline heuristic for flagging a page as potentially risky before a
 * download from it is captured. This is NOT a threat-intelligence lookup —
 * there is no API key or external service wired up, so it can only catch
 * cheap, well-known red flags. It exists to surface a caution, not to
 * guarantee safety.
 */
